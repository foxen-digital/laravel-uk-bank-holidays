...
it('renders content on bank holiday', function () {
    $view = Blade::render('@bankholiday("2026-01-01") Holiday! @endbankholiday');

    expect($view)->toContain('Holiday!');
});

it('hides content on non-bank holiday', function () {
    $view = Blade::render('@bankholiday("2026-01-02") Holiday! @endbankholiday');

    expect($view)->not->toContain('Holiday!');
});

it('supports else clause', function () {
    $view = Blade::render('@bankholiday("2026-01-02") Holiday! @else Normal day @endbankholiday');

    expect($view)->not->toContain('Holiday!')
        ->and($view)->toContain('Normal day');
});
...
it('respects territory parameter', function () {
    ...
    $view = Blade::render('@bankholiday("2026-11-30", "scotland") Scotland holiday! @endbankholiday');

    expect($view)->toContain('Scotland holiday!');

    $view = Blade::render('@bankholiday("2026-11-30", "england-and-wales") England holiday! @endbankholiday');
