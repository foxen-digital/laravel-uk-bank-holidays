...
[![GitHub Code Style Action Status](https://img.shields.io/github/actions/workflow/status/foxen/laravel-uk-bank-holidays/fix-php-code-style-issues.yml?branch=main&label=code%20style&style=flat-square)](https://github.com/foxen/laravel-uk-bank-holidays/actions?query=workflow%3A"Fix+PHP+code+style+issues"+branch%3Amain)
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-uk-bank-holidays.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-uk-bank-holidays)
...
```bash
php artisan vendor:publish --tag="laravel-uk-bank-holidays-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-uk-bank-holidays-config"
```
...
```bash
php artisan vendor:publish --tag="laravel-uk-bank-holidays-views"
```

## Usage

```php
$bankHolidays = new Foxen\BankHolidays();
echo $bankHolidays->echoPhrase('Hello, Foxen!');
```
